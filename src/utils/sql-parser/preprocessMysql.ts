import type { MysqlPartitionConfig, MysqlPartitionType } from '../types';
...
const PARTITION_BY_REGEX = /\bPARTITION\s+BY\b/i;
...
function extractPartitionConfig(sql: string): MysqlPartitionConfig | undefined {
