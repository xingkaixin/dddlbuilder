...
export const DATABASE_OPTIONS: Array<{
  ...
  { value: 'mariadb', label: 'MariaDB', icon: SiMariadbfoundation },
  { value: 'tidb', label: 'TiDB', icon: DiMysql },
  { value: 'dm', label: 'Dameng', icon: DiMysql },
  { value: 'oceanbase', label: 'OceanBase (MySQL)', icon: DiMysql },
  { value: 'oceanbase-oracle', label: 'OceanBase (Oracle)', icon: SiOracle },
  { value: 'kingbase', label: 'Kingbase', icon: SiPostgresql },
  { value: 'gbase', label: 'GBase', icon: DiMysql },
  { value: 'polardb', label: 'PolarDB', icon: DiMysql },
  { value: 'gaussdb', label: 'GaussDB', icon: SiPostgresql },
];
