export const enUSCommon = {
  ...
  header: {
    ...
    auth: {
      ...
      dialogDescriptionSignUp:
        'Create an account, then enter the six-digit code from your email to verify your address.',
      ...
      verifyCodeDescription: 'Enter the six-digit code sent to {{email}}.',
      otpLabel: 'Six-digit code',
      otpHint: 'The code expires in 10 minutes. Check your spam folder if it hasn’t arrived.',
      verifyCode: 'Verify and sign in',
      resendCodeIn: 'Resend in {{count}} seconds',
      sendCodeFailed: 'Failed to send the code. Please try again later.',
      verifyCodeFailed: 'Verification failed. Please try again.',
      invalidOtp: 'Incorrect code. Please try again.',
      otpExpired: 'This code has expired. Please request a new one.',
      otpAttemptsExceeded: 'Too many attempts. Please request a new code.',
      otpVerified: 'Email verified. You are signed in.',
  ...
  dataTable: {
    ...
    toolbar: {
      ...
      aiPatch: 'AI Edit',
      aiPatchTip: 'Use natural language to edit the current schema and review changes one by one',
  ...
  aiPatch: {
    ...
    change: {
      table: {
        schema_name: 'Update schema',
        table_name: 'Update table name',
        table_comment: 'Update table comment',
      },
      field: {
        add: 'Add field {{field}}',
        remove: 'Remove field {{oldField}}',
        modify: 'Update field {{field}}',
        rename: 'Rename {{oldField}} to {{field}}',
      },
      index: {
        add: 'Add index {{index}}',
        remove: 'Remove index {{index}}',
        modify: 'Update index {{index}}',
      },
    },
    fieldChangeType: {
      type: 'type',
  ...
  savedTables: {
    ...
    toast: {
      ...
      workspaceNotReady: 'Workspace is not ready',
      tableNotFound: 'Saved table not found',
      loadFailed: 'Failed to load',
      ...
      noChangesToSave: 'The loaded table has no changes to save',
      nameExists: 'Name already exists, choose another one',
      tableSaved: 'Saved: {{name}}',
      tableUpdated: 'Updated: {{name}}',
      tableRenamed: 'Renamed to: {{name}}',
      tableTrashed: 'Moved to trash: {{name}}',
  ...
  fieldStandards: {
    ...
    localHint:
      'Standards are stored in this browser and can be exported for sharing or backup. Field references sync with tables; import the same library on other devices.',
    name: 'Business name',
    unit: 'Business unit',
    description: 'Business definition',
    editorHint:
      'Define one standard field. Updating a standard reports differences without changing referencing tables.',
    cancel: 'Cancel',
    save: 'Save standard',
    operationFailed: 'Operation failed. Check the file format or browser storage and retry.',
    retry: 'Retry',
    create: 'New standard',
    export: 'Export standards',
    import: 'Import standards',
    importPreview:
      'Import {{count}} standards, replacing {{conflicts}} with matching IDs. Existing table fields will not change.',
    confirmImport: 'Confirm merge',
    search: 'Search names, fields or definitions',
    loading: 'Loading…',
    empty: 'No matching standards. Create one or use a current field.',
    target: 'Current table field',
    selectField: 'Select a field to reference a standard',
    fromField: 'Create standard from this field',
    noDescription: 'No business definition yet',
    property: 'Property',
    current: 'Current value',
    expected: 'Standard value',
    nameConflict: 'Another field has this name. Applying or adding would create a duplicate.',
    apply: 'Apply and link standard',
    linkOnly: 'Link without changing field',
    append: 'Add standard field',
    edit: 'Edit standard',
    applyHint:
      'Applying overwrites the properties shown above. Review highlighted differences; saving the table and executing migrations are separate steps.',
    delete: 'Delete this standard…',
    deleteHint:
      'Fields and reference IDs are preserved and reported as missing. Import the same ID to restore the reference.',
    confirmDelete: 'Confirm deletion',
    references: 'Standards referenced by this table',
    noReferences: 'This table has no standard references.',
    missing: 'Missing standard',
    drift: '{{count}} differences',
    matches: 'Matches standard',
    inspect: 'Review differences',
    detach: 'Unlink',
    scan: 'Check saved tables',
    scanHint:
      'Checks saved tables in the current workspace, excluding unsaved drafts. Unlinked fields with matching names are included. Results are a snapshot; check again after editing tables.',
    scanCount: 'Found {{count}} references or matching field names.',
    unlinked: 'Not linked',
    properties: {
      fieldName: 'Field name',
      fieldType: 'Type',
      fieldComment: 'Comment',
      nullable: 'Nullable',
      defaultKind: 'Default strategy',
      defaultValue: 'Default value',
      onUpdate: 'Update strategy',
      enumMeta: 'Enumerations',
    },
  },
  erDiagram: {
    title: 'ER Diagram',
    ...
    relationship: {
      ...
      sourceField: 'Local field',
      targetField: 'Referenced field',
      cardinality: 'Cardinality',
      manyToOne: 'Many to one',
      manyToOneHint: 'Multiple records can reference one record',
      oneToOne: 'One to one',
      oneToOneHint: 'The local field must remain unique',
      optionality: 'Relationship requirement',
      required: 'Required',
      optional: 'Optional',
      name: 'Foreign key name',
      onDelete: 'When referenced record is deleted',
      onUpdate: 'When referenced key is updated',
      createIndex: 'Create an index for the foreign key',
      createIndexHint: 'An existing usable index will be reused',
      uniqueIndex: 'Enforce uniqueness for one-to-one',
      uniqueIndexHint: 'A one-to-one relationship requires a primary or unique index',
      preview: 'Changes to create',
      willCreateIndex: 'Create index',
      willUpdateNullability: 'Update field nullability',
      noTargetKey:
        'The referenced table has no single-field primary or unique key. Update that table first.',
      warnings: {
        'field-type-mismatch':
          'The field types differ. Confirm that the database accepts this foreign key.',
      },
      errors: {
        'missing-name': 'Enter a foreign key name.',
        'missing-source-field': 'Select a local field.',
        'missing-target-field': 'Select a referenced field.',
        'target-field-not-key':
          'The referenced field must be a single-field primary or unique key.',
        'duplicate-relationship': 'A relationship already exists between these fields.',
      ...
      cancel: 'Cancel',
      saving: 'Creating',
      success: 'Table relationship created',
      saveFailed: 'Could not save the table relationship. Try again.',
    },
    toast: {
