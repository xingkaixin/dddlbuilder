...
const templates: FieldTemplate[] = [
  {
    ...
    fields: [
      ...
      { fieldName: 'username', fieldType: 'varchar(64)', nullable: false },
    ],
    createdAt: Date.now(),
    updatedAt: Date.now(),
  },
  {
    ...
    fields: [{ fieldName: 'created_at', fieldType: 'datetime', nullable: false }],
  ...
  },
  {
    ...
    name: '审计日志',
    description: '记录审计轨迹',
    fields: [{ fieldName: 'operator', fieldType: 'varchar(32)', nullable: false }],
